...
(function() {
  var $, diff_wordsToChars;

  $ = jQuery;

  diff_wordsToChars = function(text1, text2) {
    var lineArray, wordHash, wordsToChars;
    wordsToChars = function(text) {
      var chars, word, wordEnd, wordStart;
      chars = "";
      wordStart = 0;
    ...
    lineArray = [""];
    wordHash = {};
    return [wordsToChars(text1), wordsToChars(text2), lineArray];
  };
    ...
    prettyTextDiff: function(options) {
      ...
      return this.each(function() {
        ...
        if (["WORD", "LINE"].includes(mode)) {
          fragments = mode === "WORD" ? diff_wordsToChars(original, changed) : Object.values(dmp.diff_linesToChars_(original, changed));
